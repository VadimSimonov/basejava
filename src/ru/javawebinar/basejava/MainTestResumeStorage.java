...
public class MainTestResumeStorage {
    ...
    public static void main(String[] args) {
        ...
        Organization organization=new Organization("Vasya","yandex.ru");
        Position position=new Position(startDate,endDate,"админ","все супер");
        organization.addExtension(position);
